...
function Swatch({
  ...
  return (
    <div className="flex min-w-0 flex-col gap-1.5">
      ...
      />
      <span className="truncate text-[11px] font-medium" style={{ color: fg }}>
        {label}
      </span>
      <span
            ...
            >
              <div className="flex min-w-0 items-center gap-3">
                <div
                  ...
                  aria-hidden
                />
                <span className="truncate font-semibold">VideoOps</span>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="truncate text-sm" style={{ color: p.muted }}>
                            {row.client}
                          </div>
                        </div>
